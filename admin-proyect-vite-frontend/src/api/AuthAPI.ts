...
import { ConfirmToken, UserRegistrationForm, RequestConfirmationCodeForm, UserLoginForm} from '../types';
...
export {createAccount, confirmAccount, requestConfirmationCode, authenticaterUser};